...
- At any point, you can type `exit`, `quit`, or `bye` to end the conversation.

> This is a simulation. Your responses are stored temporarily and not shared or used for real hiring.
...
Let's get started! 🚀
        ...
        **👉 Please use the side navigation bar to move to the next section.**
        ...
        with col2:
            ...
            selected_role = st.selectbox("🔍 Select matched role:", matched_roles or database["Role"].dropna().unique().tolist())
